...
const services = [
  { id: 1, title: "Education", className: "education", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laudantium dicta nulla nemo natus laborum voluptate recusandae quos!" },
  { id: 2, title: "Health Care", className: "health-care", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laudantium dicta nulla nemo natus laborum voluptate recusandae quos!" },
  { id: 3, title: "Culture", className: "culture", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laudantium dicta nulla nemo natus laborum voluptate recusandae quos!" },
  { id: 4, title: "Emergency Reliefs", className: "crisis", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laudantium dicta nulla nemo natus laborum voluptate recusandae quos!" },
];
...
export default function AboutUsPage() {
  ...
  const [values, setValues] = useState({ prevIndex: 0, currentIndex: 1, nextIndex: 2 });
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setValues((prevValues) => {
        ...
        const next = prevValues.nextIndex === valuesList.length - 1
          ? 0
  ...
  return (
    <main>
      <BreadCrumb self={breadcrumb.self} ancestors={breadcrumb.ancestors} classType="about-bg" />
      {/* hero section */}
      ...
      <section className="container-fluid section vision-and-mission-container">
        <div className="mission-container vision-container">
          ...
          <div>
            ...
            <h1 className="main-title">To Empower African Citizens, And Establishing Long-Term Income</h1>
            <p className="secondary-p">
              To empower African citizens', families', and communities' rights by
              promoting purposeful and responsive legislation, stakeholder empowerment,
              good governance, and responsive service delivery.<br />
              We take a social development approach that includes empowering communities,
              fostering peace and social justice, increasing access to public services,
              combating prejudice, and establishing long-term income and economic
              structures.
            </p>
          </div>
        </div>
        <div className="vision-container">
          <div>
            ...
            <p className="secondary-p">
              Around <span>431 million</span> Africans on the continent are living
              below the extreme poverty line and underprivileged, OASD vision is
              the well-being of a society in which there is an established system
              of social growth and citizens enjoy their social, political, and
              economic rights.
            </p>
          </div>
          <div className="image-container">
      ...
      <section className="container-fluid section services">
        <div className="services-title">
          ...
          <h1 className="main-title">Benefits Children, Families, And Communities In Need Throughout Africa</h1>
        </div>
        <div className="services-slider">
          <div className={`slide ${currentService.className} ${showService ? 'visible' : 'hidden'}`}>
            <div className="text-warper">
              <h1 className="primary-title">

                {currentService.title.split("").map((letter, index) => (
                  <span key={index} className="letter-slide" style={{ animationDuration: `${currentService.title.length * 0.3 + 1}s`, animationDelay: `${index * 0.3 + 2.7}` }}>{letter.toUpperCase()}</span>
                ))}
        ...
        <div className="articles-warper">
          ...
          <div className="cards-warper">
            ...
            <TeamCard name="Dr.Suad Abdalla" thumbnail="director_2" >
              ...
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, illo! Quisquam, laboriosam quidem?
            </TeamCard>
