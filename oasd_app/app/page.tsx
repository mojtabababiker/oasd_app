        ...
        <div className="header-warper">
          <InView as="div" className="col-12 col-md-6 header-title-col opicity-0" threshold={1} onChange={(inView, entry) => {
            ...
            <h3 className="secondary-title">
              Around 431 million Africans are living below extreme poverty and underprivileged
            </h3>
            {/* actions button */}
      ...
      <div className="container-fluid programs-hero">
        <div className="programs-warper">
          {programs.map((program, index) =>
            <ProgramCard key={index} title={program.title} icon={`/images/icons/${program.icon}`} link={program.link} />
          )}
        </div>
      </div>
